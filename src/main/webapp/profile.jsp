...
<div class="container-fluid">
    ...
    <input id="me" type="hidden" value="${sessionScope.user.id}">
    <input id="guide" type="hidden" value="${id}">
    ...
    <div class="row" align="center">
        ...
        <div class="col-sm-6 name-font" align="left">
            ...
            <hr>
<%--
            <button onclick="getCoord()">Показать на карте</button>
--%>
...
<script>
    $('#Add_button').on('click', function () {
        ...
        let senderId = (document).getElementById('me').value;
